      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-3xl">
            <Image
              src="/images/manufacturer-info.jpg"
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-base leading-relaxed text-muted-foreground">
              {"Frankline's"} was created with a simple mission &mdash; to provide reliable, herbal
              skin protection for babies and families. Manufactured by Wisdom Creations - SMC Limited
              in Wakiso District, Uganda, our products combine natural ingredients like Mineral Oil,
              Micro Wax, Beeswax, and Essential Oils to deliver effective skincare.
            </p>
            <p className="text-base leading-relaxed text-muted-foreground">
            ...
            <div className="mt-2">
              ...
              <ul className="mt-4 flex flex-col gap-3">
                {promises.map((promise) => (
                  <li key={promise} className="flex items-center gap-3 text-sm text-foreground">
