    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Frankline's Herbal Petroleum Jelly products"
          fill
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="max-w-lg text-base leading-relaxed text-primary-foreground/80 md:text-lg">
              Specially formulated with natural herbal ingredients to protect, nourish, and keep your
              skin smooth, clear, and healthy every day. Available in Herbal Petroleum Jelly and Baby Jelly.
            </p>
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative aspect-square w-full max-w-md overflow-hidden rounded-3xl border-4 border-primary-foreground/20 shadow-2xl">
              <Image
                src="/images/herbal-jelly-closeup.jpg"
                alt="Frankline's Herbal Petroleum Jelly - For a Healthy Skin"
                fill
                className="object-cover"
                priority
              />
